...
useEffect(() => {
  ...
  const initPolkadotAPI = async (selectedChain: any) => {
    ...
    try {
      ...
      const newApi = await ApiPromise.create({ provider, types: selectedChain?.definitions.types[0].types, rpc: selectedChain?.definitions.rpc });
        ...
        <AccountsProvider>
          ...
          <div className="app-container">
            ...
            <div className="main-content">
                <Routes>
                  <Route path="/organisations/dashboard" element={<Dashboard api = {api}/>} />
